...
Congratulations! If you've landed here, you've recieved one of the OpenCTD benchtest boards/calling cards. This card allows you to build a working OpenCTD based on the [Rev7](https://github.com/OceanographyforEveryone/OpenCTD/tree/main/Retired/OpenCTD_Rev7) that you can use to practice your soldering skills, test OpenCTD components before permanently sealing them into epoxy, or build a benchtop instrument for measuring  salinity, temperature, and air pressure. This board works with the components listed in the OpenCTD Rev7 manual [Construction and Operation of the OpenCTD](https://github.com/OceanographyforEveryone/OpenCTD/blob/main/Retired/OpenCTD_Rev7/Documentation/OpenCTD_ConstructionOperation.pdf). 
...
2. [10 kOhm resistors](https://amzn.to/4cN27Rc) (2)
3. [4.7 kOhm resistor](https://amzn.to/4aIREVb) (1)
4. [2-position board mounted switch](https://www.adafruit.com/product/805) (1)

The only tools and consumables you need are a [soldering iron](https://amzn.to/4aios7I), [solder](https://amzn.to/4cMaoVF), and [flush cutters](https://amzn.to/4cDmFf0). I love the Pinecil as a simple starter soldering iron. You will need to get a [power supply](https://amzn.to/3J8Vewa) for the Pinecil. 
...
![OpenCTD Benchtest Board populated with components](https://github.com/OceanographyforEveryone/OpenCTD/blob/main/Hardware/Benchtester/BoardPopulated.png)

That's it! Your board is now ready to be populated with OpenCTD components. For instuctions on how to assemble the Adalogger, Real-time Clock, and EZO EC circuit, as well as the sensors, please refer to Chapter 6 and Chapter 7 of [Construction and Operation of the OpenCTD](https://github.com/OceanographyforEveryone/OpenCTD/blob/main/Retired/OpenCTD_Rev7/Documentation/OpenCTD_ConstructionOperation.pdf). To learn how to calibrate these sensor, you can reference the build guide or the [Calibration and Data Management](https://github.com/OceanographyforEveryone/OpenCTD/blob/main/Retired/OpenCTD_Rev7/Documentation/OpenCTD_CalibrationDataManagement.pdf) guide.

Firmware for the retired OpenCTD Rev7 can be found in the [archived directory](https://github.com/OceanographyforEveryone/OpenCTD/tree/main/Retired/OpenCTD_Rev7/Firmware)
